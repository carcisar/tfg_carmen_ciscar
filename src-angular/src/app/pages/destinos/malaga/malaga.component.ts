...
@Component({
  ...
  templateUrl: './malaga.component.html',
  styleUrls: ['./malaga.component.scss']
})
export class MalagaComponent implements OnInit, AfterViewInit {
  ...
  cargarActividades(): void {
    const destinoId = 7;  // ID para Málaga
