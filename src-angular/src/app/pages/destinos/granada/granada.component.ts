...
@Component({
  selector: 'app-granada',
  standalone: true,
  imports: [SelectComponent, FormsModule, ButtonComponent, CommonModule, SearchComponent],
  templateUrl: './granada.component.html',
  styleUrls: ['./granada.component.scss']
})
export class GranadaComponent implements OnInit, AfterViewInit {
  ...
  cargarActividades(): void {
    const destinoId = 4;  // ID para Granada
